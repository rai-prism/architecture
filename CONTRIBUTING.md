# Contributing to Prism Architecture

This document explains how to submit architectural proposals for Prism.
...
This guide covers the project-specific details for Prism.
...
decisions — choices about how Prism is built and maintained.
...
changes that affect how people use Prism.
...
- Architecture decision records: `decisions/0001-flower-as-initial-framework.md`
- Requests for comments: `comments/0001-client-training-data-contract.md`
...
When submitting a proposal, identify which parts of Prism are affected.
The major areas are:
